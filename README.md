...
"ObstacleData adlı ScriptableObject, pipe hızı, spawn aralığı, gap boyutu ve zorluk artış hızı gibi oyun parametrelerini yönetmektedir. Bu sayede kod değiştirilmeden 

Inspector üzerinden oyun dengesi ayarlanabilmektedir."
